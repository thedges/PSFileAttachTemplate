...
<b>Here are steps to use this component:</b>
  ...
  * If you are using the component in a community, by default is seems the org wide default for the PSFileAttachTemplate object will default to 'Private'. Make sure that is set to 'Public Read Only' else the component will not show in community.
